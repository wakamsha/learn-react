...
export const Stories = {
  Core: {
    Components: [
      ...
      {
        Inputs: [Button, Calendar, Checkbox, IconButton, LabeledSlider, Radio, Range, Select, TextField],
      },
      ...
      {
        Utils: [Box, Modal, Popover, SplitPane, Transition],
      },
    ],

    Hooks: [UseShuffleLetters],
  },
};
